...
list_of_files = [
    ...
    f"src/{project_name}/utils/__init__.py",    # Contain programs for reading, downloading and saving files used in whole project
    ...
    f'src/{project_name}/entity/__init__.py',   # Contains the variables that are used to stored the paths of files/folder nedded in a particular part
